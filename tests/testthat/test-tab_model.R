...
if (suppressWarnings(
  ...
  test_that("tab_model, check shows", {
    ...
    p <- tab_model(m1, m2, m3, show.intercept = FALSE, show.fstat = TRUE, show.se = TRUE, show.ci = FALSE, show.df = TRUE, p.val = "kr")
  })
  ...
  test_that("tab_model, check terms", {
    ...
    p <- tab_model(m1, m2, m3, show.intercept = FALSE, show.fstat = TRUE, show.se = TRUE, show.ci = FALSE, show.df = TRUE, p.val = "kr", rm.terms = c("Days", "Sepal.Width", "c161sex2", "barthtot"))
    p <- tab_model(m1, m2, m3, show.intercept = FALSE, show.fstat = TRUE, show.se = TRUE, show.ci = FALSE, show.df = TRUE, rm.terms = c("Sepal.Width", "c161sex2", "barthtot"))
  })
