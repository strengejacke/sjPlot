...
To plot marginal effects of interaction terms, at least two model terms need to be specified (the terms that define the interaction) for which the effects are computed. To plot marginal effects for three-way-interactions, all three terms need to be specified in the `terms`-argument.
