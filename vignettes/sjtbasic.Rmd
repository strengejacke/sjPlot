...
**sjPlot** provides a print-method for HTML-tables inside knitr-documents, so you can use the `sjt`-functions inside code chunks in knitr, and the HTML-table will be printed to the knitr-document.
