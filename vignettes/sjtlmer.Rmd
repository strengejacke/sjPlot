...
sjt.lmer(fit1, fit2)
```
`r sjt.lmer(fit1, fit2, p.kr = FALSE, no.output=TRUE)$knitr`
...
```
`r sjt.lmer(fit1, fit2, p.kr = FALSE, depvar.labels = c("Negative Impact", "Negative Impact"), no.output=TRUE)$knitr`
...
sjt.lmer(fit1, fit2, show.header = TRUE, string.est = "Estimate", 
         ...
         depvar.labels = c("Negative Impact", "Negative Impact"))
```
`r sjt.lmer(fit1, fit2, p.kr = FALSE, show.header = TRUE, string.est = "Estimate", string.ci = "Conf. Int.", string.p = "p-value", string.dv = "Response", string.pred = "Coefficients", string.interc = "Konstante", depvar.labels = c("Negative Impact", "Negative Impact"), no.output=TRUE)$knitr`
...
```
`r sjt.lmer(fit1, fit2, p.kr = FALSE, separate.ci.col = FALSE, show.std = TRUE, p.numeric = FALSE, show.re.var = F, show.aic=T, show.dev=F, show.r2=F, no.output=TRUE)$knitr`
...
```
`r sjt.lmer(fit1, fit2, p.kr = FALSE, pred.labels = c("Carer's Sex", "Hours of Care", "Elder's Dependency", "Mid Educational Level", "High Educational Level"), no.output=TRUE)$knitr`
...
```
`r sjt.lmer(fit3, fit2, fit1, p.kr = FALSE, group.pred = TRUE, no.output=TRUE)$knitr`
...
```
`r sjt.lmer(fit1, fit2, fit3, p.kr = FALSE, no.output=TRUE)$knitr`
...
sjt.lmer(fit1, fit2, fit3, 
         ...
         show.r2 = FALSE)
```
`r sjt.lmer(fit1, fit2, fit3, p.kr = FALSE, CSS = list(css.separatorcol = 'padding-right:1.5em; padding-left:1.5em;'), show.r2=F, show.icc=F, show.re.var=F, no.output=TRUE)$knitr`
...
sjt.lmer(fit1, fit2, fit3,
         ...
         show.icc = FALSE)
```
`r sjt.lmer(fit1, fit2, fit3, p.kr = FALSE, show.icc=F, show.re.var=F, no.output=TRUE)$knitr`
...
sjt.lmer(fit1, fit2, fit3,
         ...
         show.icc = FALSE)
```
`r sjt.lmer(fit1, fit2, fit3, p.kr = FALSE, show.icc=F, show.re.var=F, remove.estimates = 2, no.output=TRUE)$knitr`
...
sjt.lmer(fit1, fit2, fit3,
         ...
         show.icc = FALSE)
```
`r sjt.lmer(fit1, fit2, fit3, p.kr = FALSE, show.icc=F, show.re.var=F, remove.estimates = c("c12hour", "sex2"), no.output=TRUE)$knitr`
